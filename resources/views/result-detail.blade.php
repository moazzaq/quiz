                        ...
                        <div class="card-body">
                            ...
                            @php
                                $i=1;
                                    ...
                                    $answers = \Illuminate\Support\Facades\DB::table('answers')->where('question_id',$result->question_id)->get();
                            ...
                            @php
                                ...
                                $correctAnswers= \Illuminate\Support\Facades\DB::table('answers')->where('question_id',$result->question_id)->where('is_correct',1)->get();
